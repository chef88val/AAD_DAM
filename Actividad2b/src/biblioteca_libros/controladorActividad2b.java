...
public class controladorActividad2b implements ActionListener{
	private vistaActividad2b vista;
	private Libro libro;
	private Marshaller almacen;
	...
	public controladorActividad2b(vistaActividad2b vista, Libro libro, Marshaller almacen) {
		// TODO Auto-generated constructor stub
		this.vista = vista;
		this.libro = libro;
		this.almacen= almacen;
		almacen = new Marshaller(libros);
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if(e.getActionCommand().equals("Generar Archivo")){
		
			//Guardamos un unico elemento
			if(!camposVacios()){
				
				libros.add(new Libro(contTitulo,contAutor,scontFecha,contEditor,Integer.parseInt(scontNPag)));
				System.out.print(contTitulo+contAutor+scontFecha+contEditor+Integer.parseInt(scontNPag));
				MarshallerFIN();
			}
	...
	//Funcion especial del MArshaller
	public void MarshallerFIN(){
		almacen.crearDocumento();
		almacen.crearArbolDOM(libros);
		File file = new File(nombre_fichero);
		try {
			almacen.escribirDocumentAXml(file);
